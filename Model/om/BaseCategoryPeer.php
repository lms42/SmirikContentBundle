...
use Smirik\ContentBundle\Model\map\CategoryTableMap;
...
abstract class BaseCategoryPeer
{
    ...
    const OM_CLASS = 'Smirik\\ContentBundle\\Model\\Category';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Pid', 'Urlkey', 'Title', 'Url', 'Navigation', 'IsActive', 'Mode', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'pid', 'urlkey', 'title', 'url', 'navigation', 'isActive', 'mode', ),
        BasePeer::TYPE_COLNAME => array (CategoryPeer::ID, CategoryPeer::PID, CategoryPeer::URLKEY, CategoryPeer::TITLE, CategoryPeer::URL, CategoryPeer::NAVIGATION, CategoryPeer::IS_ACTIVE, CategoryPeer::MODE, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'PID', 'URLKEY', 'TITLE', 'URL', 'NAVIGATION', 'IS_ACTIVE', 'MODE', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'pid', 'urlkey', 'title', 'url', 'navigation', 'is_active', 'mode', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Pid' => 1, 'Urlkey' => 2, 'Title' => 3, 'Url' => 4, 'Navigation' => 5, 'IsActive' => 6, 'Mode' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'pid' => 1, 'urlkey' => 2, 'title' => 3, 'url' => 4, 'navigation' => 5, 'isActive' => 6, 'mode' => 7, ),
        BasePeer::TYPE_COLNAME => array (CategoryPeer::ID => 0, CategoryPeer::PID => 1, CategoryPeer::URLKEY => 2, CategoryPeer::TITLE => 3, CategoryPeer::URL => 4, CategoryPeer::NAVIGATION => 5, CategoryPeer::IS_ACTIVE => 6, CategoryPeer::MODE => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'PID' => 1, 'URLKEY' => 2, 'TITLE' => 3, 'URL' => 4, 'NAVIGATION' => 5, 'IS_ACTIVE' => 6, 'MODE' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'pid' => 1, 'urlkey' => 2, 'title' => 3, 'url' => 4, 'navigation' => 5, 'is_active' => 6, 'mode' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoryPeer::URLKEY);
            $criteria->addSelectColumn(CategoryPeer::TITLE);
            $criteria->addSelectColumn(CategoryPeer::URL);
            $criteria->addSelectColumn(CategoryPeer::NAVIGATION);
            $criteria->addSelectColumn(CategoryPeer::IS_ACTIVE);
            $criteria->addSelectColumn(CategoryPeer::MODE);
        } else {
            ...
            $criteria->addSelectColumn($alias . '.NAVIGATION');

...
abstract class BaseContent extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Smirik\\ContentBundle\\Model\\ContentPeer';
    ...
    public function setCategoryId($v)
    {
        ...
        if ($this->category_id !== $v) {
            $this->category_id = $v;
            $this->modifiedColumns[] = ContentPeer::CATEGORY_ID;
        }
    ...
    public function setUrlkey($v)
    {
        ...
        if ($this->urlkey !== $v) {
            $this->urlkey = $v;
            $this->modifiedColumns[] = ContentPeer::URLKEY;
        }
    ...
    public function setIsActive($v)
    {
        ...
        if ($this->is_active !== $v) {
            $this->is_active = $v;
            $this->modifiedColumns[] = ContentPeer::IS_ACTIVE;
        }
    ...
    public function setWeight($v)
    {
        ...
        if ($this->weight !== $v) {
            $this->weight = $v;
            $this->modifiedColumns[] = ContentPeer::WEIGHT;
        }
    ...
    public function setFile($v)
    {
        ...
        if ($this->file !== $v) {
            $this->file = $v;
            $this->modifiedColumns[] = ContentPeer::FILE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->urlkey = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ContentPeer::CATEGORY_ID)) {
        ...
        if ($this->isColumnModified(ContentPeer::URLKEY)) {
            $modifiedColumns[':p' . $index++]  = '`URLKEY`';
        }
        if ($this->isColumnModified(ContentPeer::IS_ACTIVE)) {
            $modifiedColumns[':p' . $index++]  = '`IS_ACTIVE`';
        }
        if ($this->isColumnModified(ContentPeer::WEIGHT)) {
            $modifiedColumns[':p' . $index++]  = '`WEIGHT`';
        }
        if ($this->isColumnModified(ContentPeer::FILE)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) $this->setUrlkey($arr[$keys[5]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ContentPeer::CATEGORY_ID)) $criteria->add(ContentPeer::CATEGORY_ID, $this->category_id);
        ...
        if ($this->isColumnModified(ContentPeer::URLKEY)) $criteria->add(ContentPeer::URLKEY, $this->urlkey);
        if ($this->isColumnModified(ContentPeer::IS_ACTIVE)) $criteria->add(ContentPeer::IS_ACTIVE, $this->is_active);
        if ($this->isColumnModified(ContentPeer::WEIGHT)) $criteria->add(ContentPeer::WEIGHT, $this->weight);
        if ($this->isColumnModified(ContentPeer::FILE)) $criteria->add(ContentPeer::FILE, $this->file);
    ...
    public function getCategory(PropelPDO $con = null)
    {
        if ($this->aCategory === null && ($this->category_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCategory->addContents($this);
             */
        }
